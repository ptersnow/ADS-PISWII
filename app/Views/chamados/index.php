...
<div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Chamados Cadastrados</h1>
            <p class="text-sm text-slate-500">Gerencie a lista de chamados do sistema</p>
        </div>
        
        <a href="/chamados/criar" 
                    ...
                    <?php foreach($chamados as $chamado ): ?>
                        <tr class="hover:bg-slate-50 transition duration-150">
                            ...
                            <td class="py-3 px-4 text-center space-x-2">
                                <a href="/chamados/detalhes?id=<?php echo $chamado['id']; ?>" 
